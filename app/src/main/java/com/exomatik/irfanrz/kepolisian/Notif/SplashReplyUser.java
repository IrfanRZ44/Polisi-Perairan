...
import com.exomatik.irfanrz.kepolisian.Activity.ReplyUser;
...
public class SplashReplyUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent homeIntent = new Intent(SplashReplyUser.this, ReplyUser.class);
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onCancelled(DatabaseError databaseError) {
            Toast.makeText(SplashReplyUser.this, databaseError.getMessage().toString(), Toast.LENGTH_SHORT).show();
        }
    };
